...
const getTouristAreas = () => {
  ...
  $.ajax({
    method: "GET",
    url:`https://apis.data.go.kr/B551011/KorWithService1/areaBasedList1?ServiceKey=${config.apikey}&numOfRows=12&pageNo=1&MobileOS=ETC&MobileApp=TestApp&contentTypeId=32&_type=json`
  })
  .done((data)=>{
